...
*-----------------------------------------------------------------------------
$PACKAGE DE.Outward
SUBROUTINE AMR.SMS.JAVA.INTERFACE(misn,deliveryPackage,genericData,errorResponse)
*-----------------------------------------------------------------------------
...
* Initialise logging data
    ...
    sMessage<EB.Logging.EbLogMsgRoutine> = "AMR.SMS.JAVA.INTERFACE"
    sMessage<EB.Logging.EbLogMsgModule> = "DE"
    sMessage<EB.Logging.EbLogMsgLogParam> = sContext
    className = "com.techmill.integration.SmsAlertsIntegration"
    methodName = "processSmsAlert"
